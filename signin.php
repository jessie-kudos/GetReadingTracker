	...
	<!-- Google translate element -->
		...
		<div class="grid-x">
			...
			<div class="medium-6 large-4 sign-in-form-cell">
				<form class="sign-in-form" action="/~jessiekl/GetReadingTracker/users/show.php" method="get">
						...
						<div class="grid-x grid-padding-x">
							<div class="medium-12 cell">
						  	...
						  	<div class="alert alert-error"><?php echo $_SESSION['info'] ?></div>
								...
								<p><input class="button expanded" type="submit" value="Sign In"></p>
								<span><p class="text-center">Don't already have a username? <a href="signup.php">Sign up here.</a></p></span>
							</div>
						</div>
					</div>
				</form>
